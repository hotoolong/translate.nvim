...
function! translate#translate(bang, start, end, ...) abort
  ...
  call editor.job_start(cmd, s:opt)
endfunction
...
" 'https://script.google.com/macros/s/AKfycbw_mRV2WossI7ObN0x3XWasgrnlLl1GppxsQ7EPCZKDj85sMNI/exec?text=sorry&source=en&target=ja'
